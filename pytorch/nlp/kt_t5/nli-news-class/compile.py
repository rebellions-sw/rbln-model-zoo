...
from encoder_only_models import NewsCategoryClassification
...
def main():
    ...
    model = NewsCategoryClassification.from_pretrained(args.weight_path, torchscript=True)
