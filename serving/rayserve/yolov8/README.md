# Ray Serve (YOLOv8)
A supplementary guide for the tutorial on serving models with Ray Serve.
...
```
$ pip3 install --extra-index-url https://pypi.rbln.ai/simple rebel-compiler==<VERSION>
```
...
# References
[YOLOv8](https://docs.rbln.ai/software/model_serving/rayserve/tutorial/yolov8.html)
