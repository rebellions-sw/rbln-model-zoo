...
class RBLNDiffusionControl2WorldGenerationPipeline:
    ...
    def _init_guardrail_models(self, rbln_config=None):
        ...
        self.guardrail = RBLNCosmosSafetyChecker.from_pretrained(
            ...
            export=True,
            rbln_config=rbln_config,
            rbln_image_size=(self.height, self.width),
        )
    ...
    def _run_model(
        ...
        assert data_batch["input_video"].shape[3] == self.height, (
            f"Resized input video height {data_batch['input_video'].shape[3]} does "
        ...
        assert data_batch["input_video"].shape[4] == self.width, (
            f"Resized input video width {data_batch['input_video'].shape[4]} does "
