: ${CHECKPOINT_DIR:="./ckpt"}
: ${RBLN_DIR:="./rbln_ckpt_multiview_lvg"}
: ${VIDEO_SAVE_DIR:="./outputs/multiview_lvg"}
: ${CONDITION_VIDEO_SAVE_DIR:="./outputs/multiview"}
...
python inference.py \
    ...
    --guidance 3 \
    --view_condition_video assets/sample_av_mv_input_rgb.mp4 \
    --initial_condition_video ${CONDITION_VIDEO_SAVE_DIR}/output.mp4 \
    --n_clip_max 3 \
    --num_input_frames 9 \
    --num_steps 30
